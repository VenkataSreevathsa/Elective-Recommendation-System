...
wb = openpyxl.load_workbook('Elective-Recommender-System(GAGAN CBD01)/code/data/prerequsite.xlsx')
wb2 = openpyxl.load_workbook('Elective-Recommender-System(GAGAN CBD01)/code/data/student.xlsx')
...
wb.save('code/data/prerequsite.xlsx')
